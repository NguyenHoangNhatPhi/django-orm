    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100, validators=[core.models.validate_restaurant_name_begin_with_a])),
                ('website', models.URLField(default='')),
                ('date_opened', models.DateField()),
                ('latitude', models.FloatField(validators=[django.core.validators.MaxValueValidator(-90), django.core.validators.MaxValueValidator(90)])),
                ...
                ('restaurant_type', models.CharField(choices=[('IT', 'Italian'), ('IN', 'Indian'), ('CH', 'Chinese'), ('GR', 'Greek'), ('MX', 'Mexican'), ('FF', 'Fast Food'), ('OT', 'Other')], default='', max_length=2)),
            ],
            options={
